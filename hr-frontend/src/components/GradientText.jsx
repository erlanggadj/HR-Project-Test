...
export default function GradientText({
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="inline-block relative z-2 text-transparent bg-clip-text pb-4 px-2"
        style={{ ...gradientStyle, backgroundPosition, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', color: 'transparent' }}
      >
        {children}
      </motion.div>
    </motion.div>
